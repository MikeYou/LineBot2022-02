...
def replyMessage(payload):
    response =request.post{"https://api.line.me/v2/bot/message/reply",headers=HEADERS, data=json.dumps(payload)}
    return 'OK'


def pushMessage(payload):
    response = request.post{"https://api.line.me/v2/bot/message/push",headers=HEADERS, data=json.dumps(payload)}
    return 'OK'
